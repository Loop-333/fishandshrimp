...
export default function FishDisplay() {
  ...
  useEffect(() => {
    fetch('/api/fish') // '/api/fish' for Prod, 'http://localhost:3001/api/fish' for Dev
      .then((res) => res.json())
      ...
      <div className="p-6 flex flex-wrap gap-6 justify-center">
        ...
        {selectedFish && (
          <div className="fixed inset-0 bg-opacity-10 flex items-center justify-center z-50">
            <div className="border bg-white max-w-2xl w-full max-h-[90vh] p-6 rounded-xl relative overflow-y-auto">
              <button
